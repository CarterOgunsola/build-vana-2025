...
`),
   ...
   */ var gt = {
    ...
    hu = { _start: 0, endTime: Gr, totalDuration: Gr },
    kt = function n(e, t, i) {
      var r = e.labels,
        s = e._recent || hu,
    ...
    Pu = function (e) {
      ...
      return i && t.length > 1 && i.config
        ? i.config.apply(
            null,
            ~e.indexOf("{") ? [Eu(t[1])] : Cu(e).split(",").map(_o)
          )
        : j._CE && Tu.test(e)
        ? j._CE("", e)
        : i;
  ...
  var Zs = function (e, t, i) {
    ...
    Ks = function (e, t) {
      return fe(e[t]) ? Xo : Ps(e[t]) && e.setAttribute ? zu : Zs;
    },
    jo = function (e, t) {
   ...
   */ var Jo,
    ...
    Qr = function (e, t) {
      ...
      return (
        ...
        (i.renderTransform = i.svg ? ud : al ? ml : cd),
        (i.uncache = 0),
        i
      );
    },
  ...
  function Sl(n, e) {
    return md(n) || vd(n, e) || Tl(n, e) || yd();
  }
  function Qe(n) {
    return gd(n) || _d(n) || Tl(n) || wd();
  }
  function gd(n) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var ma = "\\ud800-\\udfff",
    ...
    Il = "".concat(kd, "?"),
    zl = "[".concat(Ml, "]?"),
    Od = "(?:" + Dl + "(?:" + [kl, Ol, Ll].join("|") + ")" + zl + Il + ")*",
    Ld = zl + Il + Od,
    Dd = "(?:".concat(
      ["".concat(kl).concat(_a, "?"), _a, Ol, Ll, Md].join("|"),
      `
)`
    ),
    Id = RegExp(
      "".concat(va, "(?=").concat(va, ")|").concat(Dd).concat(Ld),
      "g"
    ),
    zd = [Dl, ma, Cl, Pl, Ml],
  ...
  function Yd(n) {
    ...
    return (n = Nd(n)), n && Kr(n) && !e && Rl(n) ? Gd(n) : n.split(e);
  }
  function wa(n, e) {
   ...
   */ var ze,
    ...
    Xl = function () {
      (tn = ze.core.globals().ScrollTrigger), tn && tn.core && ef();
    },
    jl = function (e) {
      return (
        (ze = e || Hl()),
  ...
  function Oc(n) {
    ...
    try {
      ...
      return console.error("Error formatting time:", e), "";
    }
  }
  ...
  async function Ef() {
    ...
    try {
      ...
      const i = new Date(),
        r = t.entries
          .filter((o) => o.event && o.event.visibility === "public")
          .map((o) => {
            var u;
            ...
            return {
              ...
              startTime: Oc(o.event.start_at),
              endTime: Oc(o.event.end_at),
              url: o.event.url || "#",
